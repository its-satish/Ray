...
class InitialScreen(QWidget):
    def __init__(self, parent=None):
        ...
        self.label = QLabel("")
        self.label.setStyleSheet("color: white; font-size:17px; margin-bottom:0;")
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        home_button.setStyleSheet("height:40px; line-height: 40px; background-color:#000a45; color: White")
        message_button = QPushButton()
        message_icon = QIcon(GraphicsDirectoryPath("Chats.png"))
        message_button.setIcon(message_icon)
        message_button.setText(" Chat")
        message_button.setStyleSheet("height:40px; line-height: 40px; background-color: #000a45; color: white")
        minimize_button = QPushButton()
        minimize_icon = QIcon(GraphicsDirectoryPath('Minimize2.png'))
        minimize_button.setIcon(minimize_icon)
        minimize_button.setStyleSheet("background-color:#000000")
        ...
        self.maximize_button.setStyleSheet("background-color:#000")
        self.maximize_button.clicked.connect(self.maximizeWindow)
        close_button = QPushButton()
        close_icon = QIcon(GraphicsDirectoryPath('Close.png'))
        close_button.setIcon(close_icon)
        close_button.setStyleSheet("background-color:#000")
